...
import { AnnotationPrefix, DOMSVGFactory, getFilenameFromUrl, PDFDateString } from "./display_utils.js";
...
class TextWidgetAnnotationElement extends WidgetAnnotationElement {
  constructor(parameters) {
    const isRenderable =
      parameters.renderForms || (!parameters.data.hasAppearance && !!parameters.data.fieldValue);
    super(parameters, { isRenderable });
  }
...
class FileAttachmentAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    if (
      !this.data.hasPopup &&
      (this.data.titleObj?.str || this.data.contentsObj?.str || this.data.richText)
    ) {
...
class AnnotationLayer {
  static #appendElement(element, id, div, accessibilityManager) {
    ...
    div.append(element);
    accessibilityManager?.moveElementInDOM(div, element, contentElement, /* isRemovable = */ false);
  }
