      ...
      containers.forEach(workspace => {
        ...
        btn.onclick = () => {
          if (this.foliaAPI.workspace) {
            ...
            this.foliaAPI.loadWorkspace(workspace.cid)
...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  // const {pdfBlob, workspaceId, documentId} = await foliaAPI.retrieveDocument()
  //
  // if (pdfBlob) {
  //
  //   foliaPDFViewer.eventBus.on('scalechanging', scaleChanging.bind(foliaPDFViewer))
  //   foliaPDFViewer.eventBus.on('pagechanging', pageChanging.bind(foliaPDFViewer))
  //   foliaPDFViewer.eventBus.on('documentloaded', documentLoaded.bind(foliaPDFViewer))
  //   addUIListeners(foliaPDFViewer)
  //   foliaAPI.startCheckContainer()
  // }
  // console.log('DOMContentLoaded', uiConfig, pdfBlob)
}, true)
